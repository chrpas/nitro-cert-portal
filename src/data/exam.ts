...
export const examQuestions: Question[] = [
  ...
  },
  {
    id: 155,
    type: 'single',
    text: "Which specific table does the Nitro processing engine use to store the timestamp of a job's last successful execution?",
    options: [
      "Nitro_PendingChanges",
      "Avensia_ContentProcessingJobs",
      "tblBigTable",
      "Nitro_JobHistory"
    ],
    correctAnswer: 1,
    explanation: "Nitro stores the datetime of the last successful run in 'Avensia_ContentProcessingJobs' to determine which rows in Nitro_PendingChanges to process next."
  },
  {
    id: 156,
    type: 'single',
    text: "When configuring Azure KeyVault for Nitro, how does the Azure UI represent the colon (:) character used in configuration keys?",
    options: [
      "A single dash (-)",
      "A dot (.)",
    ...
    correctAnswer: 2,
    explanation: "Azure KeyVault changes ':' to double underscore '__' in their UI, though you should still use colons in your C# configuration code."
  },
  {
    id: 157,
    type: 'single',
    text: "In Nitro5, what is the default behavior for 'AssemblyVersion' in the SharedAssemblyInfo.cs file generated by garn?",
    options: [
      "It matches the full Semantic Version (e.g., 5.6.1.0)",
      "It is always set to 1.0.0.0",
      "It is set to the Major version only and strips out minor/patch",
      "It is left empty for the compiler to decide"
    ],
    correctAnswer: 2,
    explanation: "As per .NET recommendations, garn sets the AssemblyVersion to the major version and strips out minor/patch to avoid unnecessary binding redirects."
  },
  {
    id: 158,
    type: 'single',
    text: "Which interface allows for 'contextual' configuration that varies by both site and market in appsettings.json?",
    options: [
      "IOptions<T>",
      "ISiteSettings",
      "INitroOptions<T>",
    ...
    correctAnswer: 2,
    explanation: "INitroOptions<T> enables setting unique config values for each site/market combination without manual retrieval logic."
  },
  {
    id: 159,
    type: 'single',
    text: "What is the mandatory naming convention for React component files in a Nitro5 project?",
    options: [
      "lower-kebab-case.tsx",
      "camelCase.tsx",
      "PascalCase.tsx",
      "snake_case.tsx"
    ],
    correctAnswer: 2,
    explanation: "Nitro5 guidelines require PascalCase for React components, while other files like hooks or utilities use lower-kebab-case."
  },
  {
    id: 160,
    type: 'single',
    text: "Which Nitro5 command is used to run all checks required by the CI pipeline (linting, tests, etc.) on a local machine?",
    options: [
      "nitro verify",
      "nitro continuous-integration",
      "nitro gatekeeper",
      "nitro build --all"
    ],
    correctAnswer: 1,
    explanation: "The 'nitro continuous-integration' task runs the same suite of checks locally that TeamCity performs on a Pull Request."
  },
  {
    id: 161,
    type: 'single',
    text: "In Voyado Elevate 4, what is the maximum number of languages supported per market?",
    options: [
      "1",
      "3",
      "5",
    ...
    correctAnswer: 2,
    explanation: "Voyado Elevate 4 (formerly Esales4) currently supports a maximum of 5 languages per individual market."
  },
  {
    id: 162,
    type: 'single',
    text: "Why is it recommended to set the DNS TTL to a minimum value (e.g., 10 minutes) a week before go-live?",
    options: [
      "To reduce the cost of DNS hosting",
      "To ensure that IP changes propagate quickly across the internet during go-live",
      "To prevent DDoS attacks on the new production server",
      "To bypass the PIN code protection"
    ],
    correctAnswer: 1,
    explanation: "Lowering the TTL ensures that when the site 'flips' to the new IP/host on go-live day, the change is picked up by users rapidly."
  },
  {
    id: 163,
    type: 'single',
    text: "How does Nitro5 handle themed favicons for environments running on Linux (DXP)?",
    options: [
      "The site ignores themes for favicons",
      "The folder name must match the theme name's casing exactly due to Linux case-sensitivity",
      "It automatically converts all theme names to lowercase",
      "It serves the same icon for all themes"
    ],
    correctAnswer: 1,
    explanation: "Because DXP runs on Linux, mismatched casing in theme folder names (e.g., 'MyTheme' vs 'mytheme') will cause 404 errors for themed assets."
  },
  {
    id: 164,
    type: 'single',
    text: "Which tool is used for emulating Azure Blob Storage locally in a Nitro5 environment?",
    options: [
      "Azure Storage Emulator v5.10",
      "Azurite",
      "LocalStack",
      "Nitro Storage Manager"
    ],
    correctAnswer: 1,
    explanation: "Azurite is the modern replacement for the deprecated Azure Storage Emulator and is bundled with Visual Studio 2022."
  },
  {
    id: 165,
    type: 'single',
    text: "What is the purpose of the 'PriceHistory' package in relation to the European Price Directive?",
    options: [
      "To calculate future price increases",
      "To store the lowest price of a product within the last 30 days",
      "To notify customers when a price drops",
      "To compare site prices against competitors"
    ],
    correctAnswer: 1,
    explanation: "The PriceHistory package tracks historical changes to comply with laws requiring disclosure of the lowest price in the preceding 30 days."
  },
  {
    id: 166,
    type: 'single',
    text: "In the Nitro SPA architecture, which MVC filter is responsible for serializing the view model into JSON for AJAX requests?",
    options: [
      "NitroJsonFilter",
      "ScopeAsyncActionFilter",
      "ReactResultFilter",
      "SpaMiddleware"
    ],
    correctAnswer: 1,
    explanation: "ScopeAsyncActionFilter intercepts requests and serializes the result into JSON if the request is identified as a 'Scope request'."
  },
  {
    id: 167,
    type: 'single',
    text: "What happens if you try to use `services.BuildServiceProvider()` within the `Startup.cs` file of a Nitro project?",
    options: [
      "It is the recommended way to fetch registered services",
      "It is strongly discouraged because it can cause singletons to be instantiated twice",
      "It is required to initialize the Optimizely database",
      "It has no effect in .NET 8"
    ],
    correctAnswer: 1,
    explanation: "Building the service provider manually during startup is dangerous and can lead to duplicate singletons or failures due to unfulfilled dependencies."
  },
  {
    id: 168,
    type: 'single',
    text: "Which HTML attribute is used as the standard selection target for Nitro's automated Cypress tests?",
    options: [
      "id",
      "class",
      "data-test-id",
    ...
    correctAnswer: 2,
    explanation: "Nitro uses data-test-id as a stable selector to decouple test logic from CSS classes or IDs used for styling."
  },
  {
    id: 169,
    type: 'single',
    text: "What query parameter can be used to see the full JSON view model sent from the backend for the current page?",
    options: [
      "?debug",
      "?json",
      "?scope",
    ...
    correctAnswer: 2,
    explanation: "Appending ?scope to the URL allows developers to inspect the raw JSON data returned by the Scope framework for the current context."
  },
  {
    id: 170,
    type: 'single',
    text: "Which library does Nitro use to pool and reuse connections for outgoing HTTP requests to avoid SNAT port exhaustion?",
    options: [
      "HttpClientDirect",
      "IHttpClientFactory",
      "RestSharp",
    ...
    correctAnswer: 1,
    explanation: "Using IHttpClientFactory is required to efficiently manage the lifecycle of underlying HttpClientHandlers."
  },
  {
    id: 171,
    type: 'single',
    text: "In a B2B scenario, why must customer-unique prices be added via the 'api/PriceImport' endpoint rather than the Commerce UI?",
    options: [
      "Because the UI doesn't support the PriceGroup property",
      "Because the UI is slower",
      "Because UI-added prices are always public",
      "Because the UI is only for B2C"
    ],
    correctAnswer: 0,
    explanation: "The Optimizely Commerce UI does not provide fields for PriceGroup, which is necessary for defining prices restricted to specific customer groups."
  },
  {
    id: 172,
    type: 'single',
    text: "What is the primary benefit of 'Virtual Categories' for SEO and site navigation?",
    options: [
      "They increase the number of pages indexed by Google",
      "They are excluded from indexing so they don't clutter breadcrumbs or search facets",
      "They automatically generate meta tags",
      "They allow for 301 redirects to be handled in PIM"
    ],
    correctAnswer: 1,
    explanation: "Virtual categories are 'helper' nodes for filtering and are intentionally hidden from indices and site navigation."
  },
  {
    id: 173,
    type: 'single',
    text: "How does Voyado link its contact data to an Optimizely Commerce user profile?",
    options: [
      "By email address only",
      "Using the CrmId and CustomerNumber fields in the cls_Contact table",
      "Using the user's browser cookie ID",
      "They are not linked; data is looked up in real-time by phone number"
    ],
    correctAnswer: 1,
    explanation: "The connection is persisted in the commerce database using specific CRM-related ID fields."
  },
  {
    id: 174,
    type: 'single',
    text: "In the Nitro project lifecycle, which phase involves comparing customer requirements against Nitro's baseline features?",
    options: [
      "Sprint 0",
      "Detailing phase",
      "UAT phase",
    ...
    correctAnswer: 1,
    explanation: "The detailing phase includes GAP-analysis to determine what needs to be adapted or implemented for the specific customer."
  },
  {
    id: 175,
    type: 'boolean',
    text: "True or False: The 'setup-dev-env' task in Nitro5 has been simplified to only ask if you want to restore your databases as a YES/NO option.",
    options: [
      "True",
      "False"
    ],
    correctAnswer: 0,
    explanation: "True. Nitro5 improved the setup-dev-env process to be more user-friendly compared to the classic version."
  }
];